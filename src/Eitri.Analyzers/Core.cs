...
// TokenEstimator lives in ../Shared/TokenEstimator.cs (namespace Brokkr.Tokenization),
// linked as source into both this analyzer and Heimdall.Cli so the compile-time budget
// and the `heimdall estimate` harness share one implementation and never drift.
